  ...
  <body>
      ...
      <div class="container">
        <nav id="main-nav">
          ...
          <ul>
            ...
            <li><a href="work.php" class="current">Work</a></li>
    ...
    <section id="work-a" class="text-center py-3">
      <div class="container">
        ...
        <p class="lead">
          Check out some of my Subject knowledge
        </p>
        <div class="items">
          <div class="item">
            ...
            <div class="item-text">
              <div class="item-text-wrap">
                <p class="item-text-category">3rd Semester</p>
                <h2 class="item-text-title">Data Stucture</h2>
              </div>
            </div>
          </div>
          <div class="item">
            ...
            <div class="item-text">
              <div class="item-text-wrap">
                <p class="item-text-category">4th Semester</p>
                <h2 class="item-text-title">Theory of Computation</h2>
              </div>
            </div>
          </div>
          <div class="item">
            ...
            <div class="item-text">
              <div class="item-text-wrap">
                <p class="item-text-category">2nd Semester</p>
                <h2 class="item-text-title">Electronics Device and circuit</h2>
              </div>
            </div>
          </div>
          <div class="item">
            ...
            <div class="item-text">
              <div class="item-text-wrap">
                <p class="item-text-category">1st Semester</p>
                <h2 class="item-text-title">Engineering Graphics</h2>
              </div>
            </div>
          </div>
          <div class="item">
            ...
            <div class="item-text">
              <div class="item-text-wrap">
                <p class="item-text-category">3rd Semester</p>
                <h2 class="item-text-title">Discrete Mathematics</h2>
              </div>
            </div>
          </div>
          <div class="item">
            ...
            <div class="item-text">
              <div class="item-text-wrap">
                <p class="item-text-category">6th Semester</p>
                <h2 class="item-text-title">Database Management System</h2>
              </div>
            </div>
          </div>
          <div class="item">
            ...
            <div class="item-text">
              <div class="item-text-wrap">
                <p class="item-text-category">4th Semester</p>
                <h2 class="item-text-title">Microprocessor and Interfacing</h2>
              </div>
            </div>
          </div>
          <div class="item">
            ...
            <div class="item-text">
              <div class="item-text-wrap">
                <p class="item-text-category">3rd Semester</p>
                <h2 class="item-text-title">Digital design</h2>
              </div>
            </div>
          </div>
          <div class="item">
            ...
            <div class="item-text">
              <div class="item-text-wrap">
                <p class="item-text-category">4th Semester</p>
                <h2 class="item-text-title">Operating Systems</h2>
              </div>
            </div>
          </div>
        </div>
