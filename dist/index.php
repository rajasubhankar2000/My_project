    ...
    <div class="container">
      ...
      <div class="specials">
        <div>
          ...
          <h3>Concepting</h3>
          <p>
            i'm a not very positive person, but this whole concept of having to always be nice, always smiling, always happy, that's not real. It was like I was wearing a mask.
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <h3>Visual Design</h3>
          <p>
            It is the use of imagery, color, shapes, typography, and form to enhance usability and improve the user experience. Visual design as a field has grown out of both UI design and graphic design.
          </p>
        </div>
        <div>
    ...
    <div class="stats">
      <div>
        <ul>
          ...
          <li class="stats-title">Friends</li>
      ...
      <div>
        <ul>
          ...
          <li class="stats-number">35 days</li>
        </ul>
      </div>
      <div>
        <ul>
    ...
    <div class="container">
      ...
      <div class="process">
        <div>
          ...
          <p>
            Preparation is the primary key to success, no matter what industry you’re in.I first learn then looked out the proper things to express.
          </p>
        </div>
        <div>
          ...
          <p>
            Teachers helps a lot for understanding the things in better way.this things makes my concept more clear.
          </p>
        </div>
        <div>
          ...
          <p>
            UX design itself is the process of planning the future product, while UI puts these ideas into the user interface. UX design and UI design are often confused, or considered to be one and the same thing
          </p>
        </div>
        <div>
          ...
          <h3>Interaction</h3>
          <p>
            Learn the entire spectrum of Web design from 3 beginner to advanced courses. Get taught by industry experts.
          </p>
        </div>
      </div>
    </div>
